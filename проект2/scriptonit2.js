...
function f() {
	...
	else {lava.style.backgroundImage = kartinka;}
	     }
...
easy.addEventListener('click', function() {easy.style.borderColor = "#1fff8f";

					   hard.style.borderColor = "#0064a5";

					   slognost = 70})

hard.addEventListener('click', function() {hard.style.borderColor = "#1fff8f";
...
function granica() {if (r < 1) {if (koordinatavragTop > 200)	{a = 270;
		    ...
		    if (r >= 1) {if (koordinatavragTop > 200) {vrag.style.top = koordinatavragTop - 5 + "px";

						                        	koordinatavragTop = koordinatavragTop - 5}

				 
				 if (koordinatavragTop < - 100) {vrag.style.top = koordinatavragTop + 5 + "px";

						                        	koordinatavragTop = koordinatavragTop + 5}


				 if (koordinatavrag > 500) {vrag.style.left = koordinatavrag - 5 + "px";

						                        	koordinatavrag = koordinatavrag - 5}


				 if (koordinatavrag < - 100) {vrag.style.left = koordinatavrag + 5 + "px";
...
if (a == 0 || a == 360 || a == - 360) {
	...
	if (koordinatavragTop > 200 || koordinatavragTop < - 100 || koordinatavrag > 500 || koordinatavrag < - 100) granica();
		...
		if (i < 1) dvigenieVraga(); 
			...
			if (i >= 1) {if (a == 90 || a == - 270)	      	       {vrag.style.top = koordinatavragTop + 5 + "px";

						                        	koordinatavragTop = koordinatavragTop + 5}

			     	     if (a == 180 || a == - 180)               {vrag.style.left = koordinatavrag - 5 + "px";

						                        	koordinatavrag = koordinatavrag - 5}
												
			     	     if (a == 270 || a == - 90)                {vrag.style.top = koordinatavragTop - 5 + "px";

						                        	koordinatavragTop = koordinatavragTop - 5}								

			     	     if (a == 360 || a == - 360 || a == 0)     {vrag.style.left = koordinatavrag + 5 + "px";
		...
		i = i + 1;
		if (i >= 6) { clearInterval(vragDvigenieInterval);
...
function dvigenieVraga() {t = a;
			  ...
			  vrag.style.transform = `rotate(${a}deg)`;
					...
					if (t == 90 || t == - 270)	      	  {vrag.style.top = koordinatavragTop + 105 + "px";
										   koordinatavragTop = koordinatavragTop + 105}
						                       

			     		if (t == 180 || t == - 180)               {vrag.style.left = koordinatavrag - 105 + "px";
										   koordinatavrag = koordinatavrag - 105}
						                        
												
			    		if (t == 270 || t == - 90)                {vrag.style.top = koordinatavragTop - 105 + "px";
										   koordinatavragTop = koordinatavragTop - 105}
						                        							

			     		if (t == 360 || t == - 360 || t == 0)     {vrag.style.left = koordinatavrag + 105 + "px";
										   koordinatavrag = koordinatavrag + 105}

						                        }


function dvigenieVraga2() {t = a;
...
var tops2 = parseInt(KoordinataWarloka.top);
	...
	if (koordinatavragTop > 200 || koordinatavragTop < - 100 || koordinatavrag > 500 || koordinatavrag < - 100) granica();
				...
				if (a == 90 || a == - 270)	      	       {vrag.style.top = koordinatavragTop + 5 + "px";
				...
				i = i + 1;
				if (i >= 5) { clearInterval(vragDvigenieInterval);
...
if (kudaIdti > 0 && kudaIdti <= 0.3) {vragDvigenieInterval = setInterval(jd, slognost)}

if (kudaIdti > 0.3 && kudaIdti <= 0.7) {vragDvigenieInterval = setInterval(jp, slognost)}

if (kudaIdti > 0.7 && kudaIdti <= 1) {vragDvigenieInterval = setInterval(jl, slognost)}
...
case 37: 
	...
	if (left <= 200 && -tops >= left * 0.5 + 10) {ObektWarlok.style.backgroundColor = "black";  gameover.style.opacity = 1; document.removeEventListener("keydown", DvizenieWarloka)}; 


	if (left > 200 && (-tops >= (left - 200) * (-0.5) + 100)) {ObektWarlok.style.backgroundColor = "black";  gameover.style.opacity = 1; document.removeEventListener("keydown", DvizenieWarloka)};

	
	if (left <= 200 && tops >= left * 0.5 + 200) {ObektWarlok.style.backgroundColor = "black";  gameover.style.opacity = 1; document.removeEventListener("keydown", DvizenieWarloka)}; 


	if (left > 200 && tops >= ((left - 200) * (-0.5) + 100 + 190)) {ObektWarlok.style.backgroundColor = "black";  gameover.style.opacity = 1; document.removeEventListener("keydown", DvizenieWarloka)}; 

		
	if (left > 370 || left < -5) {ObektWarlok.style.backgroundColor = "black";  
				      gameover.style.opacity = 1;
				      document.removeEventListener("keydown", DvizenieWarloka)}; 
...
if (sc >= 2000) {sc = 2000;
	...
	if (iii < 11) {titri.style.opacity = iii/10}

	if (iii == 11) {titriName.style.opacity = 1}

	if (iii == 14) {konsultanti.style.opacity = 1;

			konsultantiName.style.opacity = 1}

	if (iii >= 15) {clearInterval(scoreInterval)}
