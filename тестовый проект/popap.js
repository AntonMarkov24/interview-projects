...
PopapBtn_capmuses.addEventListener('click', function() {Popap_capmuses.classList.toggle("PopapOpen")})
...
PopapBtn_directions.addEventListener('click', function() {Popap_directions.classList.toggle("PopapOpen")})
...
PopapBtn_specialty.addEventListener('click', function() {Popap_specialty.classList.toggle("PopapOpen")})


var PopapBtn_campus = document.getElementById('PopapBtn_campus');
var Popap_campus = document.getElementById('Popap_campus');

PopapBtn_campus.addEventListener('click', function() {Popap_campus.classList.toggle("PopapOpen")})


var PopapBtn_programs = document.getElementById('PopapBtn_programs');
var Popap_programs = document.getElementById('Popap_programs');

PopapBtn_programs.addEventListener('click', function() {Popap_programs.classList.toggle("PopapOpen")})
