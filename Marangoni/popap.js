window.onload = function () {
  ...
  PopapBtn_TrainingCourses.addEventListener('click', function () {
    ...
    if (PopapClose !== "undefined" && PopapClose !== null) {
      PopapClose.classList.remove("PopapOpen")
    }
    if (PopapClose !== Popap_TrainingCourses) {
      Popap_TrainingCourses.classList.toggle("PopapOpen")
    }
  })
  ...
  PopapBtn_capmuses.addEventListener('click', function () {
    ...
    if (PopapClose !== Popap_capmuses) {
      Popap_capmuses.classList.toggle("PopapOpen")
    }
  })
  ...
  PopapBtn_directions.addEventListener('click', function () {
    ...
    if (PopapClose !== Popap_directions) {
      Popap_directions.classList.toggle("PopapOpen")
    }
  })
  ...
  PopapBtn_specialty.addEventListener('click', function () {
    ...
    if (PopapClose !== Popap_specialty) {
      Popap_specialty.classList.toggle("PopapOpen")
    }
  })
  ...
  PopapBtn_campus.addEventListener('click', function () {
    ...
    if (PopapClose !== Popap_campus) {
      Popap_campus.classList.toggle("PopapOpen")
    }
  })
  ...
  PopapBtn_programs.addEventListener('click', function () {
    ...
    if (PopapClose !== Popap_programs) {
      Popap_programs.classList.toggle("PopapOpen")
    }
  })
  ...
  PopapBtn_language.addEventListener('click', function () {
    ...
    if (PopapClose !== Popap_language) {
      Popap_language.classList.toggle("PopapOpen")
    }
  })
  ...
  PopapBtn_SP.addEventListener('click', function () {
    ...
    if (PopapClose !== Popap_SP) {
      Popap_SP.classList.toggle("PopapOpen")
    }
  })
